...
<header v-if="!editable" class="entity-header" :class="{ 'entity-header--no-image': !entity.files.header }">
    ...
    <div class="entity-header__single--content">
        <div class="leftSide">
            ...
            <a v-if="entity.twitter" :href="buildSocialMediaLink('twitter')" class="button button--text button--icon" aria-label="Twitter" target="_blank">
                    <mc-icon name="twitter"></mc-icon>
                </a>
                <a v-if="entity.linkedin" :href="buildSocialMediaLink('linkedin')" class="button button--text button--icon" aria-label="LinkedIn" target="_blank">
                    <mc-icon name="linkedin"></mc-icon>
                </a>
                <a v-if="entity.youtube" :href="buildSocialMediaLink('youtube')" class="button button--text button--icon" aria-label="YouTube" target="_blank">
                    <mc-icon name="youtube"></mc-icon>
                </a>
                <a v-if="entity.vimeo" :href="buildSocialMediaLink('vimeo')" class="button button--text button--icon" aria-label="Vimeo" target="_blank">
                    <mc-icon name="vimeo"></mc-icon>
                </a>
                <a v-if="entity.spotify" :href="buildSocialMediaLink('spotify')" class="button button--text button--icon" aria-label="Spotify" target="_blank">
                    <mc-icon name="spotify"></mc-icon>
                </a>
                <a v-if="entity.facebook" :href="buildSocialMediaLink('facebook')" class="button button--text button--icon" aria-label="Facebook" target="_blank">
                    <mc-icon name="facebook"></mc-icon>
                </a>
                <a v-if="entity.instagram" :href="buildSocialMediaLink('instagram')" class="button button--text button--icon" aria-label="Instagram" target="_blank">
                    <mc-icon name="instagram"></mc-icon>
                </a>
                <a v-if="entity.telegram" :href="buildSocialMediaLink('telegram')" class="button button--text button--icon" aria-label="Telegram" target="_blank">
                    <mc-icon name="telegram"></mc-icon>
                </a>
                <a v-if="entity.pinterest" :href="buildSocialMediaLink('pinterest')" class="button button--text button--icon" aria-label="Pinterest" target="_blank">
                    <mc-icon name="pinterest"></mc-icon>
                </a>
                <a v-if="entity.whatsapp" :href="buildSocialMediaLink('whatsapp')" class="button button--text button--icon" aria-label="WhatsApp" target="_blank">
