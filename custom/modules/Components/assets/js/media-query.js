...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  install: function install(app) {
    var mediaQueries = vue__WEBPACK_IMPORTED_MODULE_0__.reactive([]);
    app.config.globalProperties.$media = function (query) {
      if (!mediaQueries[query]) {
        var mql = globalThis.matchMedia("(".concat(query, ")"));
