                        ...
                        <label class="document-label" for="cpf">
                            ...
                            <div class="question">
                                <VMenu class="popover">
                                    ...
                                    <template #popper>
                                        <?= i::__('O CPF (Cadastro de Pessoas Físicas) garante a identificação única de cada indivíduo, prevenindo duplicações e fraudes.') ?>
                                    </template>
                                </VMenu>
                            </div>
                        </label>
                        <input type="text" name="cpf" id="cpf" v-model="cpf" @input="applyCpfMask" maxlength="14" />
                    </div>
